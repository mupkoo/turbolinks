...
var RenderingTests = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_f) {
                switch (_f.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.nextEventNamed("turbolinks:before-render")];
                    case 1:
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, this.nextEventNamed("turbolinks:render")];
                    case 4:
                        _f.sent();
                        _c = this.assert;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.nextEventNamed('turbolinks:load')];
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, this.body];
                    case 3:
    ...
    RenderingTests.prototype["test replaces entire body when nav from custom root => normal"] = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.goToLocation("/fixtures/custom_root_selector.html")];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.body];
                    case 2:
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        lastBodyId = (_a.sent()).elementId;
                        return [4 /*yield*/, this.querySelector('#rendered-by')];
                    case 3: return [4 /*yield*/, (_a.sent()).getVisibleText()];
                    case 4:
                        lastOutside = _a.sent();
                        return [4 /*yield*/, this.querySelector('h1')];
                    case 5: return [4 /*yield*/, (_a.sent()).getVisibleText()];
                    case 6:
                        lastInside = _a.sent();
                    ...
                    case 8:
                        thisBodyId = (_a.sent()).elementId;
                        return [4 /*yield*/, this.querySelector('#rendered-by')];
                    case 9: return [4 /*yield*/, (_a.sent()).getVisibleText()];
                    case 10:
                        thisOutside = _a.sent();
                        return [4 /*yield*/, this.querySelector('h1')];
                    case 11: return [4 /*yield*/, (_a.sent()).getVisibleText()];
                    case 12:
                        thisInside = _a.sent();
    ...
    RenderingTests.prototype.modifyBodyBeforeCaching = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.remote.execute(function () { return addEventListener("turbolinks:before-cache", function eventListener(event) {
