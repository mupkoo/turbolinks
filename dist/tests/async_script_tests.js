...
var AsyncScriptTests = /** @class */ (function (_super) {
    ...
    AsyncScriptTests.prototype.setup = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.goToLocation("/fixtures/async_script.html")];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    AsyncScriptTests.prototype["test does not emit turbolinks:load when loaded asynchronously after DOMContentLoaded"] = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.eventLogChannel.read()];
                    case 1:
                        events = _a.sent();
...
export { AsyncScriptTests };
AsyncScriptTests.registerSuite();
//# sourceMappingURL=async_script_tests.js.map