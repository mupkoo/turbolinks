...
var InternTestCase = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.beforeTest()];
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, this.test()];
                    case 3:
                        _a.sent();
                        return [4 /*yield*/, this.afterTest()];
                    case 4:
                        _a.sent();
                        return [3 /*break*/, 7];
                    case 5: return [4 /*yield*/, this.teardown()];
                    case 6:
                        _a.sent();
                        return [7 /*endfinally*/];
...
export { InternTestCase };
//# sourceMappingURL=intern_test_case.js.map